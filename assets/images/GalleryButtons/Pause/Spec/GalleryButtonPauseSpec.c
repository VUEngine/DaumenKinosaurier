...
extern uint32 GalleryButtonPauseLeftTiles[];
extern uint32 GalleryButtonPauseLeftTilesFrameOffsets[];
extern uint16 GalleryButtonPauseLeftMap[];
extern uint32 GalleryButtonPauseRightTiles[];
extern uint32 GalleryButtonPauseRightTilesFrameOffsets[];
...
CharSetROMSpec GalleryButtonPauseLCharset =
{
	...
	GalleryButtonPauseLeftTilesFrameOffsets,
};
...
CharSetROMSpec GalleryButtonPauseRCharset =
{
	...
	// pointer to the frames offsets
	GalleryButtonPauseRightTilesFrameOffsets,
};
